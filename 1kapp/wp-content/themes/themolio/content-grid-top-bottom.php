 ...
 */
?>
<?php global $themolio_options, $themolio_grid_item_count; ?>
<?php if($themolio_grid_item_count == 1): ?><div class="grid-col<?php themolio_grid_col_class(); ?>"><?php endif; ?>
...
<?php if(($themolio_grid_item_count % ceil(get_option('posts_per_page')/$themolio_options['grid_columns'])) == 0): ?>
    </div><div class="grid-col<?php themolio_grid_col_class(); ?>">
<?php endif; ?>
<?php themolio_grid_item_count_incr(); ?>