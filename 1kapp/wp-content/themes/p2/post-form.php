...
<div id="postbox">
		<ul id="post-types">
			<li><a id="status" class="post-format-button"<?php if ( 'status' == $post_format ) : ?> class="selected"<?php endif; ?> href="<?php echo site_url( '?p=status' ); ?>" title="<?php esc_attr_e( 'Status Update', 'p2' ); ?>"><?php esc_attr_e( 'Status Update', 'p2' ); ?></a></li>
